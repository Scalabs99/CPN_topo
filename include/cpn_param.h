...
typedef struct CPN_Param
{
	...
	char d_topoGrad_file[STD_STRING_LENGTH];		 // topo data ( with gradflow ) file name
	char d_grad_file[STD_STRING_LENGTH];			 // gradient flow file name
	char d_cool_file[STD_STRING_LENGTH];			 // cooling file name
	char d_argP_file[STD_STRING_LENGTH];		     // argP file name
...
void init_topograd_file(FILE **, CPN_Param const *const);
void init_grad_file(FILE **, CPN_Param const *const);
void init_cool_file(FILE **, CPN_Param const *const);
void init_argP_file(FILE **, CPN_Param const *const);
