...
void measure_RK3(CPN_Conf const *const, Geometry const *const, CPN_Param const *const, CPN_Conf *, CPN_Conf *, CPN_Conf *, CPN_Conf *);
...
void RK3_gradient_flow(CPN_Conf *, CPN_Conf *, CPN_Conf *, CPN_Conf *, Geometry const *const, CPN_Param const *const);
